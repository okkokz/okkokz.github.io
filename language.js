...
const kazakhContent = {
  ...
  '.order > div': '<p class="eyebrow">Сұрақтарыңыз қалды ма?</p><h2>Тапсырмаңызды<br>WhatsApp-та талқылайық</h2><p>Қандай қызмет керек екенін жазыңыз, тақырып пен мерзімді көрсетіп, талаптар болса қосыңыз.</p>',
